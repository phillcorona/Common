...
PATH_TO_CLIENT="/home/fcorona-/Documents/42/Core/Minitalk/client"
...
if [[ $t6 == 1 || $tb == 1 ]]
then
    echo "${L_Green}\n [Test 6]\tTesting the connexion between server-client, sending str with 5 300 char (15 times)${NC}"
    for i in {1..15}
    do
        echo -n "${L_Green} [ ${i} ]${NC}"
        $PATH_TO_CLIENT $p_id "
